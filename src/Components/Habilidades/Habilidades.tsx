...
import {
	SiTypescript as TSImg,
	SiStyledcomponents as StyledImg
} from 'react-icons/si'
	...
	return (
		<AnimateFadeDiv>
			...
			<ContainerSkills>
				...
				<Skills index={4} title='NextJS' image={<Nextjs />} />
				<Skills index={5} title='React' image={<ReactImg />} />
				<Skills index={6} title='TypeScript' image={<TSImg />} />
				<Skills index={7} title='Styled-Components' image={<StyledImg />} />
			</ContainerSkills>
			<Title>Outros Conhecimentos</Title>
			<ContainerSkills>
				<Skills index={8} title='Responsividade' image={<PhoneImg />} />
				<Skills index={9} title='TailwindCSS' image={<TailImg />} />
				<Skills index={10} title='SCSS' image={<SassImg />} />
				<Skills index={11} title='Git-Github' image={<GitImg />} />
			</ContainerSkills>
			<Title>Idiomas</Title>
			<ContainerSkills>
				<Skills index={12} title='Inglês-US' image={<ENImg />} />
				<Skills index={13} title='Português-BR' image={<BrImg />} />
			</ContainerSkills>
